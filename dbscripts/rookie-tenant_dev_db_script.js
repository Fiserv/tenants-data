db.tenants.insertOne({
                title: 'rookie-tenant',tenantHost: 'https://tenant-generic.dev-developer-portal.svc',tenantPort: '8443',providerAPIUrl: '/v1/products/SampleTenant',apiAuth: {},productTags: [{category: 'Region', 
        value: 'Region',
        ...
        betaTag: true,
        internalTag: true,
        name: 'rookie-tenant',github: 'rookie-tenant',selfServiceFeatures: [
            {
