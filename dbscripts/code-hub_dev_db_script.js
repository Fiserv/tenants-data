db.tenants.insertOne({
                title: 'code-hub',tenantHost: 'https://tenant-generic.dev-developer-portal.svc',tenantPort: '8443',providerAPIUrl: '/v1/products/SampleTenant',apiAuth: {},productTags: [{category: 'Region', 
        value: 'Region',
        ...
        betaTag: true,
        internalTag: true,
        name: 'code-hub',github: 'code-hub',selfServiceFeatures: [
            {
          ...
          ],gitHubFeatureBranches: [
            {
                ...
                value: 'develop',
                available: true,
                hasApis: true, sandboxType: false,
