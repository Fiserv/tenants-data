db.tenants.insertOne({
                title: 'test-hub',tenantHost: 'https://tenant-generic.dev-developer-portal.svc',tenantPort: '8443',providerAPIUrl: '/v1/products/SampleTenant',apiAuth: {},productTags: [{category: 'Region', 
        value: 'Region',
        tags: ['North America','EMEA','LATAM','APAC'],},{category: 'Integration Type', 
        value: 'Integration Type',
        tags: ['restful','sdk'],},{category: 'Industry', 
        value: 'Industry',
        tags: ['Banking'],},],active: true,
        betaTag: true,
        internalTag: true,
        name: 'test-hub',github: 'test-hub',selfServiceFeatures: [
            {
