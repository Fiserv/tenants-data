db.tenants.insertOne({
  title: 'Catalyst API for External Usage',
  name: 'CatalystAPIforExternalUsage',
  tenantHost: 'https://tenant-generic.stage-developer-portal.svc',
  tenantPort: '8443',
  providerAPIUrl: '/v1/products/CatalystAPIforExternalUsage',
  apiAuth: {},
  hasApis: true,
  productTags: [
    {
  ...
  betaTag: false,
  internalTag: false,
  github: 'catalyst-ap-ifor-external-usage',
  selfServiceFeatures: [
    {
