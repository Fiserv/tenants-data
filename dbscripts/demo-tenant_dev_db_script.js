db.tenants.insertOne({
                title: 'demo-tenant',tenantHost: 'https://tenant-generic.dev-developer-portal.svc',tenantPort: '8443',providerAPIUrl: '/v1/products/SampleTenant',apiAuth: {},productTags: [{category: 'Region', 
        value: 'Region',
        tags: ['North America','EMEA','LATAM','APAC'],},{category: 'Integration Type', 
        value: 'Integration Type',
        tags: ['restful'],},{category: 'Industry', 
        value: 'Industry',
        tags: ['Retail'],},],active: true,
        betaTag: true,
        internalTag: true,
        name: 'demo-tenant',github: 'demo-tenant',selfServiceFeatures: [
            {
